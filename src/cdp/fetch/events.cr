...
module Cdp::Fetch
  struct RequestPausedEvent
    ...
    @[JSON::Field(key: "responseErrorReason", emit_null: false)]
    property response_error_reason : Cdp::Network::ErrorReason?
    @[JSON::Field(key: "responseStatusCode", emit_null: false)]
    ...
    @[JSON::Field(key: "networkId", emit_null: false)]
    property network_id : Cdp::Network::RequestId?
    @[JSON::Field(key: "redirectedRequestId", emit_null: false)]
  ...
  struct AuthRequiredEvent
    ...
    @[JSON::Field(key: "resourceType", emit_null: false)]
    property resource_type : Cdp::Network::ResourceType
    @[JSON::Field(key: "authChallenge", emit_null: false)]
